...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (tabsList) {
    ...
    const tabIcons = {
      ...
      'Specification': '<span style="margin-right: 0.3rem; line-height: 0.85em; font-size: 1.4em; vertical-align: middle; display: inline-block; transform: translateY(-1px);">⊾</span>'
    };
  ...
  function addPageNavigation() {
    ...
    // Previous: use the previous link in sidebar, or link to main site for first page
    if (currentIndex > 0) {
      prevItem = { label: 'Previous', ...allLinks[currentIndex - 1] };
    } else {
      // First page - link to main site
